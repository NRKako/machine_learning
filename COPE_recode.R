...
d2[,c(190, 194, 195, 198, 199, 204, 205, 208, 209)] <- 4 - d2[,c(190, 194, 195, 198, 199, 204, 205, 208, 209)]
# check
...
## Export
write.csv(d2, "/Users/junopinder/Desktop/Research/Project COPE/cleaned_cope_data_randomized_corrected.csv", row.names = T)

## Compare NAs
sapply(d2[,c(358, 535, 359, 536, 363, 537, 361, 538, 364, 539, 366, 540, 367, 541, 359, 536)], function(x) sum(is.na(x)))
